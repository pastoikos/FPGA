...
set Library     "hls"
set IPName      "bilateralFilterKernel"
set Version     "1.0"
set DisplayName "Bilateralfilterkernel"
set Revision    "2001171327"
set Description "An IP generated by Vivado HLS"
set Device      "zynquplus"
set AutoFamily  ""
set Taxonomy    "/VIVADO_HLS_IP"
set has_xpm_memory "0"
set sdx_kernel_name "bilateralFilterKernel"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set xo_hls_files_dir ""
set hdl_module_list {bilateralFilterKernel_fsub_32ns_32ns_32_10_full_dsp_1
...
## Variables
set Top "bilateralFilterKernel"
set TopNoPrefix "bilateralFilterKernel"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 out_offset W 0x0 "Data signal of out_offset" {{0 32 out_offset W 0 "Bit 31 to 0 Data signal of out_offset"}}} {0x18 pad_depth_offset W 0x0 "Data signal of pad_depth_offset" {{0 32 pad_depth_offset W 0 "Bit 31 to 0 Data signal of pad_depth_offset"}}} {0x20 size_x W 0x0 "Data signal of size_x" {{0 32 size_x W 0 "Bit 31 to 0 Data signal of size_x"}}} {0x28 size_y W 0x0 "Data signal of size_y" {{0 32 size_y W 0 "Bit 31 to 0 Data signal of size_y"}}} {0x30 gaussian_offset W 0x0 "Data signal of gaussian_offset" {{0 32 gaussian_offset W 0 "Bit 31 to 0 Data signal of gaussian_offset"}}} {0x38 e_d W 0x0 "Data signal of e_d" {{0 32 e_d W 0 "Bit 31 to 0 Data signal of e_d"}}} {0x40 r W 0x0 "Data signal of r" {{0 32 r W 0 "Bit 31 to 0 Data signal of r"}}} {0x48 start W 0x0 "Data signal of start" {{0 32 start W 0 "Bit 31 to 0 Data signal of start"}}} {0x50 end_r W 0x0 "Data signal of end_r" {{0 32 end_r W 0 "Bit 31 to 0 Data signal of end_r"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_out_r m_axi_pad_depth m_axi_gaussian"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_pad_depth {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_pad_depth"
        data_width "32"
        param_prefix "C_M_AXI_PAD_DEPTH"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_gaussian {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gaussian"
        data_width "32"
        param_prefix "C_M_AXI_GAUSSIAN"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 3.11 machine 64 combinational 0 latency undef II x}
