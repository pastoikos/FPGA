...
int main(int argc, char ** argv) {
	...
	off_t PageOffset = (off_t) INPUT_BASE_ADDR % getpagesize();
	off_t PageAddress = (off_t) (INPUT_BASE_ADDR - PageOffset);
	inputDepth = (ushort *) mmap(0,inputSize.x * inputSize.y*sizeof(ushort), PROT_READ|PROT_WRITE, MAP_SHARED, devmem, PageAddress);
