...
set id 31
set name integrateKernel_fsub_32ns_32ns_32_4_full_dsp_1
...
set id 57
set name integrateKernel_fdiv_32ns_32ns_32_8_1
...
set id 73
set name integrateKernel_uitofp_32s_32_3_1
...
set id 75
set name integrateKernel_uitofp_32ns_32_3_1
set corename simcore_uitofp
set op uitofp
set stage_num 3
set max_latency -1
...
set id 76
set name integrateKernel_sitofp_32ns_32_3_1
...
set id 78
set name integrateKernel_sitofp_32s_32_3_1
set corename simcore_sitofp
set op sitofp
set stage_num 3
set max_latency -1
...
set id 80
set name integrateKernel_fcmp_32ns_32ns_1_1_1
...
set id 102
set name integrateKernel_fsqrt_32ns_32ns_32_7_1
...
set ID 112
set hasByteEnable 0
set MemName integrateKernel_depth_hls
...
set ID 113
set hasByteEnable 0
set MemName integrateKernel_input_data_0_x
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 16
set AddrRange 128
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 114 \
			corename integrateKernel_control_axilite \
			name integrateKernel_control_s_axi \
			ports {$port_control} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrateKernel_control_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    delay_budget 8.75 \ 
    is_flushable 0 \ 
    name {integrateKernel_vol_data_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'vol_data'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrateKernel_vol_data_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    delay_budget 8.75 \ 
    is_flushable 0 \ 
    name {integrateKernel_depth_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'depth'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrateKernel_depth_m_axi
}
