...
// ==============================================================
#ifndef __integrateKernel_sitofp_32s_32_3_1__HH__
#define __integrateKernel_sitofp_32s_32_3_1__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(integrateKernel_sitofp_32s_32_3_1) {
    ...
    SC_CTOR(integrateKernel_sitofp_32s_32_3_1):  ACMP_sitofp_U ("ACMP_sitofp_U") {
