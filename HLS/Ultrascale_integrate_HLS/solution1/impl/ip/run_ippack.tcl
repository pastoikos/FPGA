...
## Variables
set Top "integrateKernel"
set TopNoPrefix "integrateKernel"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 size_1 W 0x0 "Data signal of size" {{0 32 size W 0 "Bit 31 to 0 Data signal of size"}}} {0x14 size_2 W 0x0 "Data signal of size" {{0 32 size W 0 "Bit 63 to 32 Data signal of size"}}} {0x18 size_3 W 0x0 "Data signal of size" {{0 32 size W 0 "Bit 95 to 64 Data signal of size"}}} {0x20 vol_data_offset W 0x0 "Data signal of vol_data_offset" {{0 32 vol_data_offset W 0 "Bit 31 to 0 Data signal of vol_data_offset"}}} {0x28 dim_1 W 0x0 "Data signal of dim" {{0 32 dim W 0 "Bit 31 to 0 Data signal of dim"}}} {0x2c dim_2 W 0x0 "Data signal of dim" {{0 32 dim W 0 "Bit 63 to 32 Data signal of dim"}}} {0x30 dim_3 W 0x0 "Data signal of dim" {{0 32 dim W 0 "Bit 95 to 64 Data signal of dim"}}} {0x38 depth_offset W 0x0 "Data signal of depth_offset" {{0 32 depth_offset W 0 "Bit 31 to 0 Data signal of depth_offset"}}} {0x40 depthSize_x W 0x0 "Data signal of depthSize_x" {{0 32 depthSize_x W 0 "Bit 31 to 0 Data signal of depthSize_x"}}} {0x48 depthSize_y W 0x0 "Data signal of depthSize_y" {{0 32 depthSize_y W 0 "Bit 31 to 0 Data signal of depthSize_y"}}} {0x50 invTrack_data_1 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 31 to 0 Data signal of invTrack_data"}}} {0x54 invTrack_data_2 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 63 to 32 Data signal of invTrack_data"}}} {0x58 invTrack_data_3 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 95 to 64 Data signal of invTrack_data"}}} {0x5c invTrack_data_4 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 127 to 96 Data signal of invTrack_data"}}} {0x60 invTrack_data_5 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 159 to 128 Data signal of invTrack_data"}}} {0x64 invTrack_data_6 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 191 to 160 Data signal of invTrack_data"}}} {0x68 invTrack_data_7 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 223 to 192 Data signal of invTrack_data"}}} {0x6c invTrack_data_8 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 255 to 224 Data signal of invTrack_data"}}} {0x70 invTrack_data_9 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 287 to 256 Data signal of invTrack_data"}}} {0x74 invTrack_data_10 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 319 to 288 Data signal of invTrack_data"}}} {0x78 invTrack_data_11 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 351 to 320 Data signal of invTrack_data"}}} {0x7c invTrack_data_12 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 383 to 352 Data signal of invTrack_data"}}} {0x80 invTrack_data_13 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 415 to 384 Data signal of invTrack_data"}}} {0x84 invTrack_data_14 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 447 to 416 Data signal of invTrack_data"}}} {0x88 invTrack_data_15 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 479 to 448 Data signal of invTrack_data"}}} {0x8c invTrack_data_16 W 0x0 "Data signal of invTrack_data" {{0 32 invTrack_data W 0 "Bit 511 to 480 Data signal of invTrack_data"}}} {0x94 K_data_1 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 31 to 0 Data signal of K_data"}}} {0x98 K_data_2 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 63 to 32 Data signal of K_data"}}} {0x9c K_data_3 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 95 to 64 Data signal of K_data"}}} {0xa0 K_data_4 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 127 to 96 Data signal of K_data"}}} {0xa4 K_data_5 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 159 to 128 Data signal of K_data"}}} {0xa8 K_data_6 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 191 to 160 Data signal of K_data"}}} {0xac K_data_7 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 223 to 192 Data signal of K_data"}}} {0xb0 K_data_8 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 255 to 224 Data signal of K_data"}}} {0xb4 K_data_9 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 287 to 256 Data signal of K_data"}}} {0xb8 K_data_10 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 319 to 288 Data signal of K_data"}}} {0xbc K_data_11 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 351 to 320 Data signal of K_data"}}} {0xc0 K_data_12 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 383 to 352 Data signal of K_data"}}} {0xc4 K_data_13 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 415 to 384 Data signal of K_data"}}} {0xc8 K_data_14 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 447 to 416 Data signal of K_data"}}} {0xcc K_data_15 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 479 to 448 Data signal of K_data"}}} {0xd0 K_data_16 W 0x0 "Data signal of K_data" {{0 32 K_data W 0 "Bit 511 to 480 Data signal of K_data"}}} {0xd8 mu W 0x0 "Data signal of mu" {{0 32 mu W 0 "Bit 31 to 0 Data signal of mu"}}} {0xe0 maxweight W 0x0 "Data signal of maxweight" {{0 32 maxweight W 0 "Bit 31 to 0 Data signal of maxweight"}}} {0xe8 start W 0x0 "Data signal of start" {{0 32 start W 0 "Bit 31 to 0 Data signal of start"}}} {0xf0 end_r W 0x0 "Data signal of end_r" {{0 32 end_r W 0 "Bit 31 to 0 Data signal of end_r"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
